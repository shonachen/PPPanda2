...
import com.pppanda.LoggerInterceptor;
...
public final class OkHttp3Downloader implements Downloader {
    private static final String PICASSO_CACHE = "PP-Panda";
...
//                .addInterceptor(new LoggerInterceptor("PP-Panda-Picasso"))
                .sslSocketFactory(sslContext.getSocketFactory())
                .hostnameVerifier(DO_NOT_VERIFY);
        if(com.pppanda.cache.Cache.ISDEBUG){
            mBuilder.addInterceptor(new LoggerInterceptor("PP-Panda-Picasso"));
        }
